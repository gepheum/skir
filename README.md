...
*   JavaScript/TypeScript: [plugin](https://github.com/gepheum/skir-typescript-gen), [example](https://github.com/gepheum/skir-typescript-example)
*   Python: [plugin](https://github.com/gepheum/skir-python-gen), [example](https://github.com/gepheum/skir-python-example)
*   C++: [plugin](https://github.com/gepheum/skir-cc-gen), [example](https://github.com/gepheum/skir-cc-example)
*   Java: [plugin](https://github.com/gepheum/skir-java-gen), [example](https://github.com/gepheum/skir-java-example)
*   Kotlin: [plugin](https://github.com/gepheum/skir-kotlin-gen), [example](https://github.com/gepheum/skir-kotlin-example)
*   Dart: [plugin](https://github.com/gepheum/skir-dart-gen), [example](https://github.com/gepheum/skir-dart-example)
